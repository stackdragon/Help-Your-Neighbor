...
class AddForm(FlaskForm):
	...
	itemsAdded = HiddenField('itemsAdded', default="", id="hiddenItems", validators=[DataRequired(message="A request needs to include item(s) that are between 2 and 20 characters in length."), Length(min=2, max=100)]) # used for validating whether any items have been added to the request
